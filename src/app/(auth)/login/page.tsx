    ...
    <div className="min-h-screen bg-gray-950 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 mt-2">Sign in to continue to Rematch</p>
        </div>
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-2xl p-8">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button className="flex items-center justify-center gap-2 py-3 px-4 bg-gray-800 border border-gray-700 rounded-xl text-white hover:bg-gray-750 transition-colors">
